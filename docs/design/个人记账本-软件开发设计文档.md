...
| 版本 | 主题 | 主要新增 |
| --- | --- | --- |
| v1.0（MVP） | 本地记账核心 | 记账、账户、分类、流水、报表、导入导出、多账本 |
| v1.1 | 财务管控 | 应用锁、预算、周期账单、自动备份、深色主题 |
| v1.2 | 体验增强 | 多币种+汇率、标签/场景、系统托盘快捷记账、更多报表维度 |
| v2.0 | 数据连通 | 银行卡/支付宝账单 CSV 智能导入（模板映射）、数据可视化大屏 |
| v3.0 | 云同步 | 账号体系、端到端加密云同步、Web 端/Mobile 端 |
| v4.0 | 智能 | AI 账单分类、月度消费洞察报告、异常消费提醒 |
